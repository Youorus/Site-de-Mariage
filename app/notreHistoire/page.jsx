      ...
      <div className="flex flex-col items-center justify-center text-center flex-grow relative z-10 px-4">
        ...
        <section className="bg-white p-6 sm:p-8 rounded-lg shadow-xl max-w-3xl iphone-se:max-w-sm iphone-14-pro:max-w-lg h-[500px] overflow-y-scroll">
          ...
          <div className="mt-6 text-justify space-y-6 text-lg sm:text-xl iphone-se:text-base iphone-14-pro:text-lg leading-relaxed">
            <p>
              <strong>La rencontre des tangentes</strong> — Il était une fois...
              Tout commence au point <strong>4.0482183N, 9.7010417E</strong>{" "}
              pour elle et au point <strong>5.43471N, 10.419E</strong> pour lui,
              soit 239 km l’un de l’autre. Elle partira pour Marseille et puis
              Paris; et lui pour Cape Town et ensuite Leuven. Des trajectoires
              qui n’étaient pas prédestinées à se rencontrer mais qui ont fini
              par se croiser à Paris, par l’intermédiaire d’amis.
            </p>
            ...
            <p>
              ...
              pas « matchables » et notre histoire s’arrête à ce point !
            </p>
            ...
            <p>
              Merci d’être présents pour nous accompagner dans cette belle
              aventure et partager ce moment de convergence rempli d’amour,
